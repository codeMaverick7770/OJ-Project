      ...
      <div className="max-w-screen-xl mx-auto p-4 flex items-center justify-between">
        ...
        {user && (
          <ul className="hidden md:flex gap-8 text-lg font-medium items-center justify-center flex-grow text-white">
            ...
            <li><Link to="/problems" className="hover:underline underline-offset-8">Problems</Link></li>
            <li><Link to="/compiler" className="hover:underline underline-offset-8">Compiler</Link></li>
            <li><Link to="/leaderboard" className="hover:underline underline-offset-8">Leaderboard</Link></li>
          </ul>
        )}
      ...
      {menuOpen && (
        <ul className="md:hidden flex flex-col bg-black border-t border-white/20 text-white text-center">
          {user ? (
            ...
            <li>
              <Link to="/register" className="py-2 hover:bg-white/10 text-white">Get Started</Link>
            </li>
          )}
        </ul>
      )}
