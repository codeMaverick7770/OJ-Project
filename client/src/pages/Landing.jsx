...
`}</style>
      ...
      <div className="absolute inset-0 z-0">
        {[
          ...
          <div
            key={idx}
            className="absolute w-20 h-20 floating rounded-xl border border-white/10 bg-[#2f2f2f]/40 backdrop-blur-md transition duration-300 hover:shadow-[0_0_16px_rgba(255,255,255,0.15)]"
            style={{
              top: icon.top,
              left: icon.left,
              "--delay": icon.delay,
